      ...
      >
        ...
        <form className="w-full space-y-5" onSubmit={handleLogin}>
          ...
          <div className="text-right px-2">
            <a
              href="#"
              className="text-xs text-on-surface-variant hover:text-primary transition-colors underline decoration-outline-variant/30 underline-offset-2"
            >
              Forgot Path?
            </a>
          </div>
          ...
          {/* CTA Button */}
          <button
            className="w-full py-3 mt-2 bg-primary text-on-primary rounded-full font-label-md text-label-md hover:bg-surface-tint hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300 flex justify-center items-center gap-2"
            type="submit"
          >
            Enter the Forest
            <span
